        ...
        <>
            ...
            <header className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mt-1">Manage and organize your bio links</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="glass rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-slate-600 dark:text-slate-400">Total Clicks</span>
                        <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-full">+12%</span>
                    </div>
                ...
                <div className="glass rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-slate-600 dark:text-slate-400">Active Links</span>
                    </div>
                    <div className="text-4xl font-bold">{activeLinks}</div>
                    <p className="text-sm text-slate-500 dark:text-slate-500 mt-3">of {links.length} total links</p>
                </div>

                <div className="glass rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-slate-600 dark:text-slate-400">Top Performer</span>
                    </div>
                    <div className="text-xl font-bold truncate">{topLink?.title || "N/A"}</div>
                    <p className="text-sm text-slate-500 dark:text-slate-500 mt-3">{topLink?.clicks ? `${topLink.clicks.toLocaleString()} clicks` : "No clicks yet"}</p>
                </div>
            </div>

            {/* Links List */}
            <div className="space-y-4">
                <h2 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-4">Links</h2>
