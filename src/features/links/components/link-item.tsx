        ...
        >
            <div className="flex items-center gap-4">
                ...
                <div
                    {...attributes}
                    {...listeners}
                    className="drag-handle p-2 text-slate-600 hover:text-slate-400 transition-colors cursor-grab active:cursor-grabbing"
                >
                ...
                {/* Icon */}
                <div className="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center shrink-0 text-xl border border-slate-700">
                    {link.icon || "🔗"}
                </div>
                ...
                <button
                    ...
                    className={`relative w-12 h-7 rounded-full p-1 transition-colors shrink-0 ${link.isEnabled ? "bg-primary-500" : "bg-slate-700"
                        }`}
                >
                    <span
